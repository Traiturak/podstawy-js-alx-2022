  ...
  default: { //Zadna z powyzszych
   ...
   case '/': {
          ...
          default: {
            ...
            const carsNames = ['Ford', 'Szkoda', 'Renault'];

            for (let cars of carsNames) {
              console.log(cars)
            }
...
// 1. Napisz funkcje o nazwie hello, ktora przyjmuje imie jako parametr i zwroci napis Hello + imie
        const helloName = () => {
const userName1 = prompt('Podaj swoje imie'));
...
// 2. Napisz funkcje o nazwie whichGreater, ktora poprosi uzytkownika o dwie liczby, a nastepie wyswietli w konsoli informacje, ktora liczba jest wieksza
        const twoNumbersFromUser = () => {
          const userNumber1 = parseInt(prompt('Podaj pierwsza liczbe'));
          const userNumber2 = parseInt(prompt('Podaj druga liczbe'));
          if (userNumber1 > userName2) {
            console.log(`Liczba ${userNumber1} wieksza za ${userNumber2}`)
          } else if (userNumber1 < userNumber2) {
            console.log(`Liczba ${userNumber2} wieksza za ${userNumber1}`);
          } else {
            console.log('Liczby sa rowny pomiedzy soba');
          }
        }
          twoNumbersFromUser()
